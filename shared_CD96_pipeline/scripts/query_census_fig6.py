#!/usr/bin/env python
# ====================================================================
# query_census_fig6.py  |  CD96 figure pipeline component
# reproducibility header (auto-generated; edit freely below this block)
# Inputs : (reads upstream object / raw matrix — see body)
# Outputs: (writes to ../figures or ../source_data — see body)
# Run    : python query_census_fig6.py   (or: bash run_all.sh)  |  Deps: see REPRODUCIBILITY_CHECKLIST.md
...
# NEW Figure-6 (toxicity disqualification): all 12 panel-5E genes, one clean body-wide pull.
...
OUT_DIR = os.path.join(HERE, "..", "external_data", "census")
OUT_TISSUE = os.path.join(OUT_DIR, "census_by_tissue.csv")
OUT_CT = os.path.join(OUT_DIR, "census_by_celltype.csv")
OUT_CT_GLOBAL = os.path.join(OUT_DIR, "census_celltype_global.csv")
...
def main():
    ...
    with cellxgene_census.open_soma(census_version=CENSUS_VERSION) as census:
        ...
        for ti, tis in enumerate(tissues, 1):
            ...
            qc_gene = "IL3RA"    # pDC QC: IL3RA(CD123) is canonically ~71% positive in pDCs
            il_t = ""
    ...
    print("\nDone -> external_data/census/census_by_tissue.csv, "
          "census_by_celltype.csv, census_celltype_global.csv", flush=True)
