...
# NOTE [re-path]: non-functional scratch/exploratory variant (references undefined objects,
# truncated). The Figure 1 dendrogram is produced by Figure_1_Dendrogram_plotting.R — use that.
