# ====================================================================
# LSC_fraction_in_leiden.R  |  Figure S4 (LSC fraction per leiden cluster)
# reproducibility header (auto-generated; edit freely below this block)
# Inputs : ALSF_AML_leiden.csv, AML-sample-infor.csv, Gene_feature_score_Combo_enriched.csv
# Outputs: (writes to ../figures or ../source_data — see body)
# Run    : Rscript LSC_fraction_in_leiden.R   (or: bash run_all.sh)  |  Deps: see REPRODUCIBILITY_CHECKLIST.md
...
factor_list<-dplyr::filter(mccf_final, normalized_mcc>0.7)
factor_list<-dplyr::filter(factor_list, f1>0.5)
