# Figure S19 — Discovered antigens versus antigens in clinical trials

**Self-contained.** This folder reproduces deployed **Figure S19** (`../../05_Supplementary_Figures/Figure_S19__venn_composite_vs_trials.pdf`) from its own
...
## Contents
- `scripts/` — renderer(s): figS_venn.R; builder(s): —; shared `_style.R` + `config.py` (bundled)
- `source_data/` — plot-level source data (2 files): fig5A_top15.csv, fig_aml_trials.csv
