# Figure S22 — Candidate antigens by cytogenetic subtype, adult BeatAML

**Self-contained.** This folder reproduces deployed **Figure S22** (`../../05_Supplementary_Figures/Figure_S22__cyto_violins_adult.pdf`) from its own
...
## Contents
- `scripts/` — renderer(s): figS_cyto_violin.R; builder(s): build_figS_cyto_adult.py; shared `_style.R` + `config.py` (bundled)
