...
ggsave(file.path(OUT,"Figure_S6__composition_cell_cycle.pdf"), fig, width=11, height=15)
ggsave(file.path(OUT,"Figure_S6__composition_cell_cycle.png"), fig, width=11, height=15, dpi=150)
